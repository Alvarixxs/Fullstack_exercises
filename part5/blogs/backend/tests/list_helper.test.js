...
describe('favorite blog', ()=> {
  ...
  test('of list returns one with most likes', ()=> {
    assert.strictEqual(listHelper.favoriteBlog(blogs).likes, 10)
  })

  test('returns first appearance with most likes', () => {
    assert.deepStrictEqual(
      listHelper.favoriteBlog(blogs),
      {title: "Canonical string reduction", author: "Edsger W. Dijkstra", likes: 10}
    )
  })
})
...
describe('most blogs', ()=> {
  ...
  test('of list returns one with most blogs', ()=> {
    assert.strictEqual(listHelper.mostBlogs(blogs).blogs, 3)
  })

  test('returns first appearance with most blogs', () => {
    assert.deepStrictEqual(
...
describe('most likes', ()=> {
  ...
  test('of list returns one with most likes', ()=> {
    assert.strictEqual(listHelper.mostLikes(blogs).likes, 15)
  })
